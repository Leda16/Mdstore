...
<head>
  ...
  <title>MdStore | Checkout</title>
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
  <script src="https://sdk.mercadopago.com/js/v2"></script>
  <script type="text/javascript" src="index.js" defer></script>
  <link rel="stylesheet" href="style.css">
  <link rel="shortcut icon" href="../../Public/MainLogo.png" type="image/x-icon">
</head>
<body>

<!-- FORM PARA CHECKOUT PROTEGIDO MERCADO PAGO, PQP CODIGO GIGANTE DO KRL -LASYSTEM -->
...
<form id="form-checkout" action="process_payment.php" method="POST">
  ...
  <a href="<?php echo $url;?>" class="pagarpix">Pagar com PIX?</a>
    ...
    <input id="transactionAmount" name="transactionAmount" type="hidden" value="<?php echo $preco; ?>">
    <input id="description" name="description" type="hidden" value="<?php echo $nome; ?>">
  <button type="submit" id="form-checkout__submit">Pagar Agora</button>
  <h3 class="poweredby">Powered by MercadoPago </h3>
  <svg class='powerbymer' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 48 48">
